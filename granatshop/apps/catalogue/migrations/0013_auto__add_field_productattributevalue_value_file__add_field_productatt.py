...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductAttributeValue.value_file'
        db.add_column(u'catalogue_productattributevalue', 'value_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductAttributeValue.value_image'
        db.add_column(u'catalogue_productattributevalue', 'value_image',
    ...
    def backwards(self, orm):
        # Deleting field 'ProductAttributeValue.value_file'
        db.delete_column(u'catalogue_productattributevalue', 'value_file')

        # Deleting field 'ProductAttributeValue.value_image'
        db.delete_column(u'catalogue_productattributevalue', 'value_image')
