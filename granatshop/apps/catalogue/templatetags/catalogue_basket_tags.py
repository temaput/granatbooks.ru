...
from apps.catalogue.forms import AddToBasketForm 
# AddToBasketForm = get_class('catalogue.forms', 'AddToBasketForm')  # PA: changed to catalogue
...
@register.tag(name="catalogue_basket_form")
